...
void CRobot::SaveData() {
    ...
    print.Data(333)     = temp_contact_foots(RL_FootIndex, 0);
    print.Data(334)     = temp_contact_foots(RL_FootIndex, 60);
    print.Data(335)     = temp_contact_foots(RL_FootIndex, 120);
    print.Data(336)     = temp_contact_foots(RL_FootIndex, 160);
    print.Data(337)     = temp_contact_foots(RL_FootIndex, 199);

    // print.Data(338)                 = temp_com2RL_ref(0+2);
    // print.Data(339)                 = temp_com2RL_ref(60*3+2);
    // print.Data(340)                 = temp_com2RL_ref(120*3+2);
    // print.Data(341)                 = temp_com2RL_ref(180*3+2);
    // print.Data(342)                 = temp_com2RL_ref(199*3+2);

    // print.Data(343)                 = temp_legs_ref(0+2, 2);
    // print.Data(344)                 = temp_legs_ref(60*3+2, 2);
    // print.Data(345)                 = temp_legs_ref(120*3+2, 2);
    // print.Data(346)                 = temp_legs_ref(160*3+2, 2);
    // print.Data(347)                 = temp_legs_ref(199*3+2, 2);

    // print.Data(348)                 = walking.step.start_foot;
    // print.Data(349)                 = temptime;

    // std::cout << temp_com2RL_ref.block<3, 1>(0, 0).transpose() << ", contact: " << temp_contact_foots(3, 0) << std::endl;
    // std::cout << temp_com2RL_ref.block<3, 1>(60*3, 0).transpose() << ", contact: " << temp_contact_foots(3, 60) << std::endl;
    // std::cout << temp_com2RL_ref.block<3, 1>(120*3, 0).transpose() << ", contact: " << temp_contact_foots(3, 120) << std::endl;
    // std::cout << temp_com2RL_ref.block<3, 1>(180*3, 0).transpose() << ", contact: " << temp_contact_foots(3, 180) << std::endl;
