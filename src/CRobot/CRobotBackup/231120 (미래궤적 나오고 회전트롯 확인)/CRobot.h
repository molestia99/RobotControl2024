...
public:
    ...
    void Optimization_Process(const unsigned int gait_type, const VectorXf vel_com_target, float& T_period, float& T_stance, float& T_swing, Vector3f* vel_com_desired, Vector3f* d_ori_com_desired);
