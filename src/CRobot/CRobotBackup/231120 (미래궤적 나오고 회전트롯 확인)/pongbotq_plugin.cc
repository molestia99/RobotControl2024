    ...
    if(con_count % (int) (PongBot.tasktime * onesecScale) == 0){
        ...
        if(PongBot.osqp.Flag == true){
            ...
            if(time > 5.){
                ...
                // PongBot.walk_para_array[0].v_CoM_joystick(2) = 0.1;
                ...
                for(size_t i = 1; i < horizontal_N; ++i){
                    ...
                    PongBot.walk_para_array[i].time_gait += (future_time - PongBot.walk_para_array[0].dt_gait);
                ...
                //ori_CoM_traj[2]
                std::cout << "con_count: " << con_count << std::endl;
