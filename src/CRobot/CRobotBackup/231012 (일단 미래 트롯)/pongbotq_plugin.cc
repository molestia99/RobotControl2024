        ...
        if(PongBot.osqp.Flag == true){
            ...
            if(time > 5.){
                ...
                PongBot.Foot_Traj_Generator(PongBot.walk_para_new.gait_on_off_now, PongBot.walk_para_new.gait_type, PongBot.walk_para_new.gait_phase, PongBot.walk_para_new.swingLeg,
                                                 ...
                                                 &PongBot.walk_para_new.contact_foots);


                // 미래의 CoM, 다리 궤적들을 여기서 생성
                // 1. 40ms 미래
                PongBot.Foot_Traj_Generator(PongBot.walk_para_new.gait_on_off_now, PongBot.walk_para_new.gait_type, PongBot.walk_para_new.gait_phase, PongBot.walk_para_new.swingLeg,
                                                 PongBot.walk_para_new.p_RL_now, PongBot.walk_para_new.p_RR_now, PongBot.walk_para_new.p_FL_now, PongBot.walk_para_new.p_FR_now,
                                                 PongBot.walk_para_new.p_RL_desired, PongBot.walk_para_new.p_RR_desired, PongBot.walk_para_new.p_FL_desired, PongBot.walk_para_new.p_FR_desired,
                                                 ...
                                                 &PongBot.walk_para_new.contact_foots_future1);

                PongBot.walk_para_new.p_CoM_future1_traj = PongBot.walk_para_new.p_CoM_traj + 0.040*PongBot.walk_para_new.v_CoM_desired; 
                ...
                PongBot.Foot_Traj_Generator(PongBot.walk_para_new.gait_on_off_now, PongBot.walk_para_new.gait_type, PongBot.walk_para_new.gait_phase, PongBot.walk_para_new.swingLeg,
                                                 ...
                                                 &PongBot.walk_para_new.contact_foots_future2);

                PongBot.walk_para_new.p_CoM_future2_traj = PongBot.walk_para_new.p_CoM_traj + 0.080*PongBot.walk_para_new.v_CoM_desired; 
                ...
                PongBot.Foot_Traj_Generator(PongBot.walk_para_new.gait_on_off_now, PongBot.walk_para_new.gait_type, PongBot.walk_para_new.gait_phase, PongBot.walk_para_new.swingLeg,
                                                 ...
                                                 &PongBot.walk_para_new.contact_foots_future3);

                PongBot.walk_para_new.p_CoM_future3_traj = PongBot.walk_para_new.p_CoM_traj + 0.120*PongBot.walk_para_new.v_CoM_desired; 
                ...
                PongBot.Foot_Traj_Generator(PongBot.walk_para_new.gait_on_off_now, PongBot.walk_para_new.gait_type, PongBot.walk_para_new.gait_phase, PongBot.walk_para_new.swingLeg,
                                                 ...
                                                 &PongBot.walk_para_new.contact_foots_future4);

                PongBot.walk_para_new.p_CoM_future4_traj = PongBot.walk_para_new.p_CoM_traj + 0.160*PongBot.walk_para_new.v_CoM_desired; 
                ...
                PongBot.Foot_Traj_Generator(PongBot.walk_para_new.gait_on_off_now, PongBot.walk_para_new.gait_type, PongBot.walk_para_new.gait_phase, PongBot.walk_para_new.swingLeg,
                                                 ...
                                                 &PongBot.walk_para_new.contact_foots_future5);

                PongBot.walk_para_new.p_CoM_future5_traj = PongBot.walk_para_new.p_CoM_traj + 0.200*PongBot.walk_para_new.v_CoM_desired; 
                ...
                PongBot.Foot_Traj_Generator(PongBot.walk_para_new.gait_on_off_now, PongBot.walk_para_new.gait_type, PongBot.walk_para_new.gait_phase, PongBot.walk_para_new.swingLeg,
                                                 ...
                                                 &PongBot.walk_para_new.contact_foots_future6);

                PongBot.walk_para_new.p_CoM_future6_traj = PongBot.walk_para_new.p_CoM_traj + 0.240*PongBot.walk_para_new.v_CoM_desired; 
                ...
                PongBot.Foot_Traj_Generator(PongBot.walk_para_new.gait_on_off_now, PongBot.walk_para_new.gait_type, PongBot.walk_para_new.gait_phase, PongBot.walk_para_new.swingLeg,
                                                 ...
                                                 &PongBot.walk_para_new.contact_foots_future7);

                PongBot.walk_para_new.p_CoM_future7_traj = PongBot.walk_para_new.p_CoM_traj + 0.280*PongBot.walk_para_new.v_CoM_desired; 
                ...
                PongBot.Foot_Traj_Generator(PongBot.walk_para_new.gait_on_off_now, PongBot.walk_para_new.gait_type, PongBot.walk_para_new.gait_phase, PongBot.walk_para_new.swingLeg,
                                                 ...
                                                 &PongBot.walk_para_new.contact_foots_future8);

                PongBot.walk_para_new.p_CoM_future8_traj = PongBot.walk_para_new.p_CoM_traj + 0.320*PongBot.walk_para_new.v_CoM_desired; 

                // 9. 360ms 미래
                PongBot.Foot_Traj_Generator(PongBot.walk_para_new.gait_on_off_now, PongBot.walk_para_new.gait_type, PongBot.walk_para_new.gait_phase, PongBot.walk_para_new.swingLeg,
                                                 PongBot.walk_para_new.p_RL_now, PongBot.walk_para_new.p_RR_now, PongBot.walk_para_new.p_FL_now, PongBot.walk_para_new.p_FR_now,
                                                 PongBot.walk_para_new.p_RL_desired, PongBot.walk_para_new.p_RR_desired, PongBot.walk_para_new.p_FL_desired, PongBot.walk_para_new.p_FR_desired,
                                                 PongBot.walk_para_new.t_stance, PongBot.walk_para_new.t_swing, round((PongBot.walk_para_new.time_gait + 0.360)*1000.)/1000., PongBot.walk_para_new.foot_traj_height,
                                                 PongBot.walk_para_new.t_p, PongBot.walk_para_new.v_CoM_desired, PongBot.walk_para_new.p_CoM_desired,
                                                 &PongBot.walk_para_new.p_FL_future9_traj, &PongBot.walk_para_new.p_FR_future9_traj, &PongBot.walk_para_new.p_RL_future9_traj, &PongBot.walk_para_new.p_RR_future9_traj,
                                                 &PongBot.walk_para_new.contact_foots_future8);

                PongBot.walk_para_new.p_CoM_future9_traj = PongBot.walk_para_new.p_CoM_traj + 0.360*PongBot.walk_para_new.v_CoM_desired; 


                //** contact information
                // std::cout << "present contact:      " << PongBot.walk_para_new.contact_foots.transpose()         << std::endl;
                // std::cout << " 50ms future contact: " << PongBot.walk_para_new.contact_foots_future1.transpose() << std::endl;
                // std::cout << "100ms future contact: " << PongBot.walk_para_new.contact_foots_future2.transpose() << std::endl;
                // std::cout << "150ms future contact: " << PongBot.walk_para_new.contact_foots_future3.transpose() << std::endl;
                // std::cout << "200ms future contact: " << PongBot.walk_para_new.contact_foots_future4.transpose() << std::endl;
                // std::cout << "250ms future contact: " << PongBot.walk_para_new.contact_foots_future5.transpose() << std::endl;
                // std::cout << "300ms future contact: " << PongBot.walk_para_new.contact_foots_future6.transpose() << std::endl;
                // std::cout << "350ms future contact: " << PongBot.walk_para_new.contact_foots_future7.transpose() << std::endl;
                // std::cout << "400ms future contact: " << PongBot.walk_para_new.contact_foots_future8.transpose() << std::endl;

                // PongBot.walk_para_new.contact_foots_total.block<4, 1>(0, 0) = PongBot.walk_para_new.contact_foots;
                // PongBot.walk_para_new.contact_foots_total.block<4, 1>(0, 1) = PongBot.walk_para_new.contact_foots_future1;
                // PongBot.walk_para_new.contact_foots_total.block<4, 1>(0, 2) = PongBot.walk_para_new.contact_foots_future2;
                // PongBot.walk_para_new.contact_foots_total.block<4, 1>(0, 3) = PongBot.walk_para_new.contact_foots_future3;
                // PongBot.walk_para_new.contact_foots_total.block<4, 1>(0, 4) = PongBot.walk_para_new.contact_foots_future4;
                // PongBot.walk_para_new.contact_foots_total.block<4, 1>(0, 5) = PongBot.walk_para_new.contact_foots_future5;
                // PongBot.walk_para_new.contact_foots_total.block<4, 1>(0, 6) = PongBot.walk_para_new.contact_foots_future6;
                // PongBot.walk_para_new.contact_foots_total.block<4, 1>(0, 7) = PongBot.walk_para_new.contact_foots_future7;
                // PongBot.walk_para_new.contact_foots_total.block<4, 1>(0, 8) = PongBot.walk_para_new.contact_foots_future8;

                PongBot.walk_para_new.contact_foots_total.block<4, 1>(0, 0) = PongBot.walk_para_new.contact_foots_future1;
                PongBot.walk_para_new.contact_foots_total.block<4, 1>(0, 1) = PongBot.walk_para_new.contact_foots_future2;
                PongBot.walk_para_new.contact_foots_total.block<4, 1>(0, 2) = PongBot.walk_para_new.contact_foots_future3;
                PongBot.walk_para_new.contact_foots_total.block<4, 1>(0, 3) = PongBot.walk_para_new.contact_foots_future4;
                PongBot.walk_para_new.contact_foots_total.block<4, 1>(0, 4) = PongBot.walk_para_new.contact_foots_future5;
                PongBot.walk_para_new.contact_foots_total.block<4, 1>(0, 5) = PongBot.walk_para_new.contact_foots_future6;
                PongBot.walk_para_new.contact_foots_total.block<4, 1>(0, 6) = PongBot.walk_para_new.contact_foots_future7;
                PongBot.walk_para_new.contact_foots_total.block<4, 1>(0, 7) = PongBot.walk_para_new.contact_foots_future8;
                PongBot.walk_para_new.contact_foots_total.block<4, 1>(0, 8) = PongBot.walk_para_new.contact_foots_future9;


                PongBot.contact.Foot[0] = PongBot.walk_para_new.contact_foots(0);
                PongBot.contact.Foot[1] = PongBot.walk_para_new.contact_foots(1);
                PongBot.contact.Foot[2] = PongBot.walk_para_new.contact_foots(2);
                PongBot.contact.Foot[3] = PongBot.walk_para_new.contact_foots(3);


                // std::cout << "contact block is:\n" << PongBot.walk_para_new.contact_foots_total << std::endl;

                //** reference
                PongBot.FL_Foot.G_RefPos = PongBot.walk_para_new.p_FL_traj;
                PongBot.FR_Foot.G_RefPos = PongBot.walk_para_new.p_FR_traj;
                PongBot.RL_Foot.G_RefPos = PongBot.walk_para_new.p_RL_traj;
                PongBot.RR_Foot.G_RefPos = PongBot.walk_para_new.p_RR_traj;

                PongBot.com.G_RefPos = PongBot.walk_para_new.p_CoM_traj;
                ...
                //     p_CoM2FL_traj_future.block<3, 1>(i*3, 0) = 
                // }
                PongBot.walk_para_new.p_CoM2FL_traj_future.block<3, 1>(0, 0)  = PongBot.walk_para_new.p_FL_future1_traj - PongBot.walk_para_new.p_CoM_future1_traj;
                PongBot.walk_para_new.p_CoM2FL_traj_future.block<3, 1>(3, 0)  = PongBot.walk_para_new.p_FL_future2_traj - PongBot.walk_para_new.p_CoM_future2_traj;
                PongBot.walk_para_new.p_CoM2FL_traj_future.block<3, 1>(6, 0)  = PongBot.walk_para_new.p_FL_future3_traj - PongBot.walk_para_new.p_CoM_future3_traj;
                PongBot.walk_para_new.p_CoM2FL_traj_future.block<3, 1>(9, 0)  = PongBot.walk_para_new.p_FL_future4_traj - PongBot.walk_para_new.p_CoM_future4_traj;
                PongBot.walk_para_new.p_CoM2FL_traj_future.block<3, 1>(12, 0) = PongBot.walk_para_new.p_FL_future5_traj - PongBot.walk_para_new.p_CoM_future5_traj;
                PongBot.walk_para_new.p_CoM2FL_traj_future.block<3, 1>(15, 0) = PongBot.walk_para_new.p_FL_future6_traj - PongBot.walk_para_new.p_CoM_future6_traj;
                PongBot.walk_para_new.p_CoM2FL_traj_future.block<3, 1>(18, 0) = PongBot.walk_para_new.p_FL_future7_traj - PongBot.walk_para_new.p_CoM_future7_traj;
                PongBot.walk_para_new.p_CoM2FL_traj_future.block<3, 1>(21, 0) = PongBot.walk_para_new.p_FL_future8_traj - PongBot.walk_para_new.p_CoM_future8_traj;
                PongBot.walk_para_new.p_CoM2FL_traj_future.block<3, 1>(24, 0) = PongBot.walk_para_new.p_FL_future9_traj - PongBot.walk_para_new.p_CoM_future9_traj;

                PongBot.walk_para_new.p_CoM2FR_traj_future.block<3, 1>(0, 0)  = PongBot.walk_para_new.p_FR_future1_traj - PongBot.walk_para_new.p_CoM_future1_traj;
                PongBot.walk_para_new.p_CoM2FR_traj_future.block<3, 1>(3, 0)  = PongBot.walk_para_new.p_FR_future2_traj - PongBot.walk_para_new.p_CoM_future2_traj;
                PongBot.walk_para_new.p_CoM2FR_traj_future.block<3, 1>(6, 0)  = PongBot.walk_para_new.p_FR_future3_traj - PongBot.walk_para_new.p_CoM_future3_traj;
                PongBot.walk_para_new.p_CoM2FR_traj_future.block<3, 1>(9, 0)  = PongBot.walk_para_new.p_FR_future4_traj - PongBot.walk_para_new.p_CoM_future4_traj;
                PongBot.walk_para_new.p_CoM2FR_traj_future.block<3, 1>(12, 0) = PongBot.walk_para_new.p_FR_future5_traj - PongBot.walk_para_new.p_CoM_future5_traj;
                PongBot.walk_para_new.p_CoM2FR_traj_future.block<3, 1>(15, 0) = PongBot.walk_para_new.p_FR_future6_traj - PongBot.walk_para_new.p_CoM_future6_traj;
                PongBot.walk_para_new.p_CoM2FR_traj_future.block<3, 1>(18, 0) = PongBot.walk_para_new.p_FR_future7_traj - PongBot.walk_para_new.p_CoM_future7_traj;
                PongBot.walk_para_new.p_CoM2FR_traj_future.block<3, 1>(21, 0) = PongBot.walk_para_new.p_FR_future8_traj - PongBot.walk_para_new.p_CoM_future8_traj;
                PongBot.walk_para_new.p_CoM2FR_traj_future.block<3, 1>(24, 0) = PongBot.walk_para_new.p_FR_future9_traj - PongBot.walk_para_new.p_CoM_future9_traj;

                PongBot.walk_para_new.p_CoM2RL_traj_future.block<3, 1>(0, 0)  = PongBot.walk_para_new.p_RL_future1_traj - PongBot.walk_para_new.p_CoM_future1_traj;
                PongBot.walk_para_new.p_CoM2RL_traj_future.block<3, 1>(3, 0)  = PongBot.walk_para_new.p_RL_future2_traj - PongBot.walk_para_new.p_CoM_future2_traj;
                PongBot.walk_para_new.p_CoM2RL_traj_future.block<3, 1>(6, 0)  = PongBot.walk_para_new.p_RL_future3_traj - PongBot.walk_para_new.p_CoM_future3_traj;
                PongBot.walk_para_new.p_CoM2RL_traj_future.block<3, 1>(9, 0)  = PongBot.walk_para_new.p_RL_future4_traj - PongBot.walk_para_new.p_CoM_future4_traj;
                PongBot.walk_para_new.p_CoM2RL_traj_future.block<3, 1>(12, 0) = PongBot.walk_para_new.p_RL_future5_traj - PongBot.walk_para_new.p_CoM_future5_traj;
                PongBot.walk_para_new.p_CoM2RL_traj_future.block<3, 1>(15, 0) = PongBot.walk_para_new.p_RL_future6_traj - PongBot.walk_para_new.p_CoM_future6_traj;
                PongBot.walk_para_new.p_CoM2RL_traj_future.block<3, 1>(18, 0) = PongBot.walk_para_new.p_RL_future7_traj - PongBot.walk_para_new.p_CoM_future7_traj;
                PongBot.walk_para_new.p_CoM2RL_traj_future.block<3, 1>(21, 0) = PongBot.walk_para_new.p_RL_future8_traj - PongBot.walk_para_new.p_CoM_future8_traj;
                PongBot.walk_para_new.p_CoM2RL_traj_future.block<3, 1>(24, 0) = PongBot.walk_para_new.p_RL_future9_traj - PongBot.walk_para_new.p_CoM_future9_traj;

                PongBot.walk_para_new.p_CoM2RR_traj_future.block<3, 1>(0, 0)  = PongBot.walk_para_new.p_RR_future1_traj - PongBot.walk_para_new.p_CoM_future1_traj;
                PongBot.walk_para_new.p_CoM2RR_traj_future.block<3, 1>(3, 0)  = PongBot.walk_para_new.p_RR_future2_traj - PongBot.walk_para_new.p_CoM_future2_traj;
                PongBot.walk_para_new.p_CoM2RR_traj_future.block<3, 1>(6, 0)  = PongBot.walk_para_new.p_RR_future3_traj - PongBot.walk_para_new.p_CoM_future3_traj;
                PongBot.walk_para_new.p_CoM2RR_traj_future.block<3, 1>(9, 0)  = PongBot.walk_para_new.p_RR_future4_traj - PongBot.walk_para_new.p_CoM_future4_traj;
                PongBot.walk_para_new.p_CoM2RR_traj_future.block<3, 1>(12, 0) = PongBot.walk_para_new.p_RR_future5_traj - PongBot.walk_para_new.p_CoM_future5_traj;
                PongBot.walk_para_new.p_CoM2RR_traj_future.block<3, 1>(15, 0) = PongBot.walk_para_new.p_RR_future6_traj - PongBot.walk_para_new.p_CoM_future6_traj;
                PongBot.walk_para_new.p_CoM2RR_traj_future.block<3, 1>(18, 0) = PongBot.walk_para_new.p_RR_future7_traj - PongBot.walk_para_new.p_CoM_future7_traj;
                PongBot.walk_para_new.p_CoM2RR_traj_future.block<3, 1>(21, 0) = PongBot.walk_para_new.p_RR_future8_traj - PongBot.walk_para_new.p_CoM_future8_traj;
                PongBot.walk_para_new.p_CoM2RR_traj_future.block<3, 1>(24, 0) = PongBot.walk_para_new.p_RR_future9_traj - PongBot.walk_para_new.p_CoM_future9_traj;

                // std::cout << "p_CoM2FL_traj_future: \n" << PongBot.walk_para_new.p_CoM2FL_traj_future << std::endl;
                ...
                //** 이 아래에서부터 밸런싱 제어기 삽입
                // if(static_cast<int>(time*1000) % 20 == 1){  // 20ms 마다 동작시킨다고 가정한다면
            ...
            if(static_cast<int>(time*1000) % 20 == 1){  // 20ms 마다 동작시킨다고 가정한다면
                    ...
                    std::chrono::system_clock::time_point calEndTime = std::chrono::system_clock::now();
                    auto calDiffTime = std::chrono::duration_cast<std::chrono::microseconds>(calEndTime - calStartTime);
                    if(calDiffTime.count() > 10000){
                        std::cout << "calc divergence at: " << time << "[s], calc time: " << calDiffTime.count() << "[us]" << std::endl;
                    }
