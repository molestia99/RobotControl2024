        ...
        if(PongBot.osqp.Flag == true){
            ...
            if(time > 5.){
                ...
                PongBot.Foot_Traj_Generator(PongBot.walk_para_new.gait_on_off_now, PongBot.walk_para_new.gait_type, PongBot.walk_para_new.gait_phase, PongBot.walk_para_new.swingLeg,
                                                 PongBot.walk_para_new.p_RL_now, PongBot.walk_para_new.p_RR_now, PongBot.walk_para_new.p_FL_now, PongBot.walk_para_new.p_FR_now,
                                                 PongBot.walk_para_new.p_RL_desired, PongBot.walk_para_new.p_RR_desired, PongBot.walk_para_new.p_FL_desired, PongBot.walk_para_new.p_FR_desired,
                                                 PongBot.walk_para_new.t_stance, PongBot.walk_para_new.t_swing, round((PongBot.walk_para_new.time_gait + 0.050)*1000.)/1000., PongBot.walk_para_new.foot_traj_height,
                                                 PongBot.walk_para_new.t_p, PongBot.walk_para_new.v_CoM_desired, PongBot.walk_para_new.p_CoM_desired,
                ...
                PongBot.walk_para_new.p_CoM_future1_traj = PongBot.walk_para_new.p_CoM_traj + 0.050*PongBot.walk_para_new.v_CoM_desired; 

                // 2. 100ms 미래
                PongBot.Foot_Traj_Generator(PongBot.walk_para_new.gait_on_off_now, PongBot.walk_para_new.gait_type, PongBot.walk_para_new.gait_phase, PongBot.walk_para_new.swingLeg,
                                                 PongBot.walk_para_new.p_RL_now, PongBot.walk_para_new.p_RR_now, PongBot.walk_para_new.p_FL_now, PongBot.walk_para_new.p_FR_now,
                                                 PongBot.walk_para_new.p_RL_desired, PongBot.walk_para_new.p_RR_desired, PongBot.walk_para_new.p_FL_desired, PongBot.walk_para_new.p_FR_desired,
                                                 PongBot.walk_para_new.t_stance, PongBot.walk_para_new.t_swing, round((PongBot.walk_para_new.time_gait + 0.100)*1000.)/1000., PongBot.walk_para_new.foot_traj_height,
                                                 PongBot.walk_para_new.t_p, PongBot.walk_para_new.v_CoM_desired, PongBot.walk_para_new.p_CoM_desired,
                ...
                PongBot.walk_para_new.p_CoM_future2_traj = PongBot.walk_para_new.p_CoM_traj + 0.100*PongBot.walk_para_new.v_CoM_desired; 

                // 3. 150ms 미래
                PongBot.Foot_Traj_Generator(PongBot.walk_para_new.gait_on_off_now, PongBot.walk_para_new.gait_type, PongBot.walk_para_new.gait_phase, PongBot.walk_para_new.swingLeg,
                                                 PongBot.walk_para_new.p_RL_now, PongBot.walk_para_new.p_RR_now, PongBot.walk_para_new.p_FL_now, PongBot.walk_para_new.p_FR_now,
                                                 PongBot.walk_para_new.p_RL_desired, PongBot.walk_para_new.p_RR_desired, PongBot.walk_para_new.p_FL_desired, PongBot.walk_para_new.p_FR_desired,
                                                 PongBot.walk_para_new.t_stance, PongBot.walk_para_new.t_swing, round((PongBot.walk_para_new.time_gait + 0.150)*1000.)/1000., PongBot.walk_para_new.foot_traj_height,
                                                 PongBot.walk_para_new.t_p, PongBot.walk_para_new.v_CoM_desired, PongBot.walk_para_new.p_CoM_desired,
                ...
                PongBot.walk_para_new.p_CoM_future3_traj = PongBot.walk_para_new.p_CoM_traj + 0.150*PongBot.walk_para_new.v_CoM_desired; 
                ...
                PongBot.walk_para_new.p_CoM_future4_traj = PongBot.walk_para_new.p_CoM_traj + 0.200*PongBot.walk_para_new.v_CoM_desired; 

                // 5. 250ms 미래
                PongBot.Foot_Traj_Generator(PongBot.walk_para_new.gait_on_off_now, PongBot.walk_para_new.gait_type, PongBot.walk_para_new.gait_phase, PongBot.walk_para_new.swingLeg,
                                                 PongBot.walk_para_new.p_RL_now, PongBot.walk_para_new.p_RR_now, PongBot.walk_para_new.p_FL_now, PongBot.walk_para_new.p_FR_now,
                                                 PongBot.walk_para_new.p_RL_desired, PongBot.walk_para_new.p_RR_desired, PongBot.walk_para_new.p_FL_desired, PongBot.walk_para_new.p_FR_desired,
                                                 PongBot.walk_para_new.t_stance, PongBot.walk_para_new.t_swing, round((PongBot.walk_para_new.time_gait + 0.250)*1000.)/1000., PongBot.walk_para_new.foot_traj_height,
                                                 PongBot.walk_para_new.t_p, PongBot.walk_para_new.v_CoM_desired, PongBot.walk_para_new.p_CoM_desired,
                ...
                PongBot.walk_para_new.p_CoM_future5_traj = PongBot.walk_para_new.p_CoM_traj + 0.250*PongBot.walk_para_new.v_CoM_desired; 

                // 6. 300ms 미래
                PongBot.Foot_Traj_Generator(PongBot.walk_para_new.gait_on_off_now, PongBot.walk_para_new.gait_type, PongBot.walk_para_new.gait_phase, PongBot.walk_para_new.swingLeg,
                                                 PongBot.walk_para_new.p_RL_now, PongBot.walk_para_new.p_RR_now, PongBot.walk_para_new.p_FL_now, PongBot.walk_para_new.p_FR_now,
                                                 PongBot.walk_para_new.p_RL_desired, PongBot.walk_para_new.p_RR_desired, PongBot.walk_para_new.p_FL_desired, PongBot.walk_para_new.p_FR_desired,
                                                 PongBot.walk_para_new.t_stance, PongBot.walk_para_new.t_swing, round((PongBot.walk_para_new.time_gait + 0.300)*1000.)/1000., PongBot.walk_para_new.foot_traj_height,
                                                 PongBot.walk_para_new.t_p, PongBot.walk_para_new.v_CoM_desired, PongBot.walk_para_new.p_CoM_desired,
                ...
                PongBot.walk_para_new.p_CoM_future6_traj = PongBot.walk_para_new.p_CoM_traj + 0.300*PongBot.walk_para_new.v_CoM_desired; 

                // 7. 350ms 미래
                PongBot.Foot_Traj_Generator(PongBot.walk_para_new.gait_on_off_now, PongBot.walk_para_new.gait_type, PongBot.walk_para_new.gait_phase, PongBot.walk_para_new.swingLeg,
                                                 PongBot.walk_para_new.p_RL_now, PongBot.walk_para_new.p_RR_now, PongBot.walk_para_new.p_FL_now, PongBot.walk_para_new.p_FR_now,
                                                 PongBot.walk_para_new.p_RL_desired, PongBot.walk_para_new.p_RR_desired, PongBot.walk_para_new.p_FL_desired, PongBot.walk_para_new.p_FR_desired,
                                                 PongBot.walk_para_new.t_stance, PongBot.walk_para_new.t_swing, round((PongBot.walk_para_new.time_gait + 0.350)*1000.)/1000., PongBot.walk_para_new.foot_traj_height,
                                                 PongBot.walk_para_new.t_p, PongBot.walk_para_new.v_CoM_desired, PongBot.walk_para_new.p_CoM_desired,
                ...
                PongBot.walk_para_new.p_CoM_future7_traj = PongBot.walk_para_new.p_CoM_traj + 0.350*PongBot.walk_para_new.v_CoM_desired; 

                // 8. 400ms 미래
                PongBot.Foot_Traj_Generator(PongBot.walk_para_new.gait_on_off_now, PongBot.walk_para_new.gait_type, PongBot.walk_para_new.gait_phase, PongBot.walk_para_new.swingLeg,
                                                 PongBot.walk_para_new.p_RL_now, PongBot.walk_para_new.p_RR_now, PongBot.walk_para_new.p_FL_now, PongBot.walk_para_new.p_FR_now,
                                                 PongBot.walk_para_new.p_RL_desired, PongBot.walk_para_new.p_RR_desired, PongBot.walk_para_new.p_FL_desired, PongBot.walk_para_new.p_FR_desired,
                                                 PongBot.walk_para_new.t_stance, PongBot.walk_para_new.t_swing, round((PongBot.walk_para_new.time_gait + 0.400)*1000.)/1000., PongBot.walk_para_new.foot_traj_height,
                                                 PongBot.walk_para_new.t_p, PongBot.walk_para_new.v_CoM_desired, PongBot.walk_para_new.p_CoM_desired,
                ...
                PongBot.walk_para_new.p_CoM_future8_traj = PongBot.walk_para_new.p_CoM_traj + 0.400*PongBot.walk_para_new.v_CoM_desired; 
