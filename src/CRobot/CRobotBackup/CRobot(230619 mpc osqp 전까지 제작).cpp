...
void CRobot::SaveData() {
    ...
    print.Data(343)     = temp_com_vel_ref(30);


    print.Data(344)     = FL_Foot.G_RefPos(0);  // FL: [52]
    print.Data(345)     = temp_legs_ref(30, 0);
    print.Data(346)     = temp_legs_ref(60, 0);

    print.Data(347)     = FR_Foot.G_RefPos(0);  // FR: [55]
    print.Data(348)     = temp_legs_ref(30, 1);
    print.Data(349)     = temp_legs_ref(60, 1);
...
VectorXf CRobot::MPC_controller(unsigned int horizontal_length, float samplingtime, unsigned int total_legs = 4)
{
    //** start of 입력으로 받은 변수들 또는 전역 변수들을 지역 변수로 새로 정의
    unsigned int n = total_legs;
    unsigned int l = horizontal_length;
