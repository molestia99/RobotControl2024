    ...
    if(con_count % (int) (PongBot.tasktime * onesecScale) == 0){
        ...
        switch (PongBot.CommandFlag){
            ...
            case TROT:
                ...
                PongBot.walk_para_array.v_CoM_joystick(0) = PongBot.walking.InputData[AXIS_X] * 0.02;
                // PongBot.walk_para_array.v_CoM_joystick(1) = PongBot.walking.InputData[AXIS_Y] * 0.05;
                PongBot.walk_para_array.v_CoM_joystick(1) = 0.0;
                PongBot.walk_para_array.v_CoM_joystick(2) = PongBot.walking.InputData[AXIS_YAW] * 0.05;
