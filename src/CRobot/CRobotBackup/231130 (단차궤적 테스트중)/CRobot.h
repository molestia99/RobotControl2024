...
typedef struct Walk_Parameter_new{
    ...
    Walk_Parameter_new()    
    {
        ...
        // 현재 이 시뮬레이션의 퐁봇 치수
        p_com2FL_offset <<  0.29804,  0.1988, -0.52;
        p_com2FR_offset <<  0.29804, -0.1988, -0.52;
        p_com2RL_offset << -0.29804,  0.1988, -0.52;
        p_com2RR_offset << -0.29804, -0.1988, -0.52;
