...
#define horizontal_length   5
#define mpc_sampletime 0.040
// #define mpc_sampletime 0.020
// #define mpc_sampletime 0.002

// 새로 사용중인 시간간격?
#define horizontal_N   5
...
typedef struct OSQP {
    ...
    c_int A_nnz_mpc = 60 * horizontal_length;
    c_float A_x_mpc[60 * horizontal_length];
    c_int A_i_mpc[60 * horizontal_length];
    ...
    VectorXf Ref_GRF_horizontal             = VectorXf::Zero(12*horizontal_length);
...
public:
    ...
    VectorXf temp_base_ori_ref = VectorXf::Zero(3*horizontal_N);
