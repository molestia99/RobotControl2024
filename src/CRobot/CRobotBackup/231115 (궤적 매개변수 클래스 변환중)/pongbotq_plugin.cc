...
void gazebo::PongBot_plugin::UpdateAlgorithm() {    
    ...
    if(con_count % (int) (PongBot.tasktime * onesecScale) == 0){
        ...
        if(PongBot.osqp.Flag == true){
            ...
            PongBot.walk_para_array[0].v_CoM_joystick(0) = 0.1;
            ...
            if(time > 5.){
                ...
                //     // PongBot.walk_para_new.time_gait = 0.;
                    
                //     PongBot.walk_para_new.p_CoM_traj << 0., 0., 0.4;
                //     size_t index = static_cast<size_t>(i /3);
                //     PongBot.walk_para_new.p_CoM_traj(AXIS_X) = CoM_x_middle[index] * 1.;
                //     PongBot.walk_para_new.p_CoM_traj(AXIS_Y) = CoM_y_middle[index] * 1.5;
                //     ++i;
                //     if(i >= 1500) i = 1499;                   // 500 * 3
                // } 
                ...
                //     PongBot.walk_para_new.p_CoM_traj << 0., 0., 0.4;
                //     size_t index = static_cast<size_t>(i /3);
                //     PongBot.walk_para_new.p_CoM_traj(AXIS_X) = CoM_x_after[index] * 1.;
                //     PongBot.walk_para_new.p_CoM_traj(AXIS_Y) = CoM_y_after[index] * 1.5;
                //     ++i;
                    
                //     // if(i >= 1500) {
                //     //     PongBot.walk_para_new.p_CoM_traj(AXIS_X) = CoM_x_after[499] * 1.;
                //     //     PongBot.walk_para_new.p_CoM_traj(AXIS_Y) = CoM_y_after[499] * 1.5;
