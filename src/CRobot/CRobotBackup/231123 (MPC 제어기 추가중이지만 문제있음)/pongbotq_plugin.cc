        ...
        if(PongBot.osqp.Flag == true){
            ...
            if(time > 5.){
                ...
                if(testflag){
                    ...
                    std::cout << PongBot.walk_para_new.p_FL_desired.transpose() << std::endl;
                    std::cout << PongBot.walk_para_new.p_RR_desired.transpose() << std::endl;

                    // PongBot.walk_para_new.gait_type_target = MOVE_WALK;
                    // PongBot.walk_para_new.v_CoM_joystick(AXIS_X) = 0.0;
                }
                ...
                RefPos_B << (PongBot.walk_para_array[0].p_FL_traj - PongBot.walk_para_array[0].p_CoM_traj),
                            (PongBot.walk_para_array[0].p_FR_traj - PongBot.walk_para_array[0].p_CoM_traj),
                            (PongBot.walk_para_array[0].p_RL_traj - PongBot.walk_para_array[0].p_CoM_traj),
                            (PongBot.walk_para_array[0].p_RR_traj - PongBot.walk_para_array[0].p_CoM_traj);
