        ...
        if(PongBot.osqp.Flag == true){
            ...
            if(time > 5.){
                ...
                if(time > 8. && time <= 11.){
                    ...
                    PongBot.walk_para_new.p_CoM_traj(AXIS_Y) = CoM_y_middle[index] * 1.;
                    ++i;
                    ...
                    PongBot.walk_para_new.p_CoM_traj(AXIS_Y) = CoM_y_after[index] * 1.;
                    ++i;
                    if(i >= 1500) i = 0;                   // 500 * 3
                }               
                ...
                if(time <= 8.){
                    ...
                    PongBot.walk_para_new.p_CoM_traj(AXIS_Y) = CoM_y_begin[index] * 1.;
                    ++i;
