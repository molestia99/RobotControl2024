...
void CRobot::initializeOSQP(void) {
    ...
    */
    ...
    osqp.L_d_pos << 5000., 0., 0.,
                    0., 5000., 0.,
                    0., 0., 5000.;

    osqp.weight_alpha = 0.001;

    // osqp.L_ori << 1000000., 0., 0.,
    //             0., 1000000., 0.,
    //             0., 0., 1000000.;
    ...
    // osqp.L_d_pos << 1000000., 0., 0.,
    //                 0., 1000000., 0.,
    //                 0., 0., 3000000.;                
    
    // osqp.weight_alpha = 0.00005;
    // osqp.weight_alpha = 5.*1e-7;
    // osqp.weight_alpha = 5.*1e-7;
    ...
    if (OSQP_settings) {
        ...
        OSQP_settings->eps_abs = 1e-12;
        OSQP_settings->eps_rel = 1e-12;
    }
...
void CRobot::ProcessOSQP(void) {   
    ...
    */
    ...
    //osqp.X_mpc.block<3, 1>(6, 0) = imu.AngularVel; //imu.AngularVel
    osqp.X_mpc.block<3, 1>(6, 0) = base.G_CurrentAngularVel; //imu.AngularVel
